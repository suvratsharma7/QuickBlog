    ...
    <div className='flex-1 px-5 pt-5 sm:pt-12 sm:pl-16 bg-blue-50/50'>
      <div className='flex justify-between items-center max-w-3xl'>
        ...
        <div className='flex gap-4'>
          ...
          {`shadow-custom-sm border rounded-full px-4 py-1
      ...
      rounded-lg scrollbar-hide'>
        <table className='w-full text-sm text-gray-500'>
            <thead className='text-xs text-gray-700 text-left
            uppercase'>
              <tr>
                <th scope='col' className='px-6 py-3'>
                Blog Title & Comment </th>
                <th scope='col' className='px-6 py-3
                max-sm:hidden'>Date</th>
            ...
            <tbody>
              ...
              }).map((comments,index)=><CommentTableItem key={comments._id}
              comments={comments} index={index+1} fetchComments={fetchComments}/>)}
            </tbody>
        </table>
