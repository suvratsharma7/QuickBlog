...
const Blog = () => {
  ...
  const addComment=async(e)=>{
    e.preventDefault(); 
    try {
        //const {data}=await axios.post('/api/blog/comments',{blogId:id,name,
        //content});
  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        <p className='text-primary py-4 font-medium'>Published on {Moment(data.
          createdAt).format('MMMM Do YYYY')}</p>
        ...
        border-primary/35 bg-primary/5 font-medium text-primary'>Suvrat Sharma</p>
        </div>
